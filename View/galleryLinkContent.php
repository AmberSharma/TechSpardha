<div class="panel" id="gallery">
    ...
    <div id="gallery_container">
        <div class="gallery_box">
            <img src="<?php echo SITE_URL; ?>/assets/images/gallery/image_01.jpg" alt="01" />
            <h4>Project One</h4>
        ...
        <div class="gallery_box">
            <img src="<?php echo SITE_URL; ?>/assets/images/gallery/image_02.jpg" alt="02" />
            <h4>Project No. 2</h4>
        ...
        <div class="gallery_box">
            <img src="<?php echo SITE_URL; ?>/assets/images/gallery/image_03.jpg" alt="03" />
            <h4>Project Three</h4>
        ...
        <div class="gallery_box">
            <img src="<?php echo SITE_URL; ?>/assets/images/gallery/image_04.jpg" alt="04" />
            <h4>Project No. 4</h4>
        ...
        <div class="gallery_box">
            <img src="<?php echo SITE_URL; ?>/assets/images/gallery/image_05.jpg" alt="05" />
            <h4>Project Five</h4>
        ...
        <div class="gallery_box">
            <img src="<?php echo SITE_URL; ?>/assets/images/gallery/image_06.jpg" alt="06" />
            <h4>Project No. 6</h4>
